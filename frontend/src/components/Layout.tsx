...
import { Users, Home, Menu, X, LogOut, User, BookOpen, Calendar, UserCheck, Clock, FileText } from 'lucide-react'
...
const Layout = () => {
  ...
  const allNavigationItems = [
    ...
    { 
      ...
      icon: FileText,
      allowedRoles: ['ADMIN', 'STAFF'] // Admin and staff can view booking history
    },
  ]
